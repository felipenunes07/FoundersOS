...
const NOTES = {
  ...
  offer: {
    ...
    updated: "hoje · 09:06",
    body: "Implantação do segundo cérebro em oito semanas, com entregas verificáveis e propriedade integral do cliente.",
    bullets: ["8 semanas", "8 reuniões", "zero lock-in"],
